                        ...
                        <div class="bg-white shadow">
                            <div class="px-4 py-6 sm:px-8 sm:py-10">
                                ...
                                <div class="mt-6 text-center">
                                    <Link to='/checkout'> <button type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-gray-900 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
                                        Checkout
